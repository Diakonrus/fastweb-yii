...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 27 2015 г., 23:19
...
CREATE TABLE IF NOT EXISTS `tbl_pages_tabs` (
  ...
  KEY `title` (`title`(255))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Вкладки' AUTO_INCREMENT=100 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Список подклюеных модулей' AUTO_INCREMENT=17 ;
