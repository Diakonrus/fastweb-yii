...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 17 2016 г., 14:00
...
CREATE TABLE IF NOT EXISTS `tbl_catalog_elements` (
  ...
  `name` varchar(250) CHARACTER SET cp1251 NOT NULL,
  `brieftext` text CHARACTER SET cp1251 NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1',
  `ansvtype` tinyint(3) unsigned NOT NULL,
  `execute` tinyint(4) NOT NULL,
  `url` varchar(250) DEFAULT NULL,
  `hit` smallint(6) NOT NULL,
  `image` varchar(5) CHARACTER SET cp1251 NOT NULL,
  `page_name` varchar(250) CHARACTER SET cp1251 NOT NULL,
  `description` text CHARACTER SET cp1251 NOT NULL,
  `fkey` varchar(250) CHARACTER SET cp1251 NOT NULL,
  `code` varchar(100) CHARACTER SET cp1251 NOT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=50435 ;
...
CREATE TABLE IF NOT EXISTS `tbl_catalog_filters` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Список фильтров' AUTO_INCREMENT=15 ;

-- --------------------------------------------------------

--
-- Структура таблицы `tbl_catalog_filters_category`
--

CREATE TABLE IF NOT EXISTS `tbl_catalog_filters_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) NOT NULL DEFAULT '',
  `status` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Список категорий фильтров' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `tbl_catalog_rubrics` (
  ...
  `name` varchar(250) CHARACTER SET cp1251 NOT NULL,
  `url` varchar(220) CHARACTER SET cp1251 NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1',
  `meta_title` varchar(250) CHARACTER SET cp1251 NOT NULL,
  `meta_keywords` text CHARACTER SET cp1251 NOT NULL,
  ...
  KEY `parent_id` (`parent_id`),
  KEY `status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=50512 ;
...
--
-- Структура таблицы `tbl_news_elements`
--

CREATE TABLE IF NOT EXISTS `tbl_news_elements` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) unsigned NOT NULL,
...
--
-- Структура таблицы `tbl_news_rubrics`
--

CREATE TABLE IF NOT EXISTS `tbl_news_rubrics` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) unsigned NOT NULL DEFAULT '0',
  `left_key` int(11) unsigned NOT NULL,
  `level` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_pages` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1-активно 0 -нет',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `in_footer` int(11) NOT NULL DEFAULT '0' COMMENT 'Страница находится в футере',
