...
DROP TABLE IF EXISTS `tbl_article_elements`;
...
DROP TABLE IF EXISTS `tbl_article_rubrics`;
...
DROP TABLE IF EXISTS `tbl_baners_elements`;
...
DROP TABLE IF EXISTS `tbl_baners_rubrics`;
...
DROP TABLE IF EXISTS `tbl_basket_items`;
...
DROP TABLE IF EXISTS `tbl_basket_order`;
...
DROP TABLE IF EXISTS `tbl_before_after_elements`;
...
DROP TABLE IF EXISTS `tbl_before_after_rubrics`;
...
DROP TABLE IF EXISTS `tbl_catalog_chars`;
...
DROP TABLE IF EXISTS `tbl_catalog_elements`;
...
DROP TABLE IF EXISTS `tbl_catalog_elements_discount`;
...
DROP TABLE IF EXISTS `tbl_catalog_rubrics`;
...
DROP TABLE IF EXISTS `tbl_creating_form_elements`;
...
DROP TABLE IF EXISTS `tbl_creating_form_rubrics`;
...
DROP TABLE IF EXISTS `tbl_doctor_elements`;
...
DROP TABLE IF EXISTS `tbl_doctor_rubrics`;
...
DROP TABLE IF EXISTS `tbl_doctor_specialization`;
...
DROP TABLE IF EXISTS `tbl_email_group`;
...
DROP TABLE IF EXISTS `tbl_faq_author`;
...
DROP TABLE IF EXISTS `tbl_faq_elements`;
...
DROP TABLE IF EXISTS `tbl_faq_rubrics`;
...
DROP TABLE IF EXISTS `tbl_geo_city`;
...
DROP TABLE IF EXISTS `tbl_geo_country`;
...
DROP TABLE IF EXISTS `tbl_geo_item`;
...
DROP TABLE IF EXISTS `tbl_geo_type`;
...
DROP TABLE IF EXISTS `tbl_html_code`;
...
DROP TABLE IF EXISTS `tbl_loadxml_rubrics`;
...
DROP TABLE IF EXISTS `tbl_main_tabel`;
...
CREATE TABLE IF NOT EXISTS `tbl_news` (
  ...
  KEY `status` (`status`),
  FULLTEXT KEY `name` (`name`,`brieftext`,`description`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=164 ;
...
DROP TABLE IF EXISTS `tbl_news_group`;
...
CREATE TABLE IF NOT EXISTS `tbl_pages` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1-активно 0 -нет',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `in_header` int(11) NOT NULL DEFAULT '0' COMMENT 'Страница относится к верхнему меню',
...
INSERT INTO `tbl_pages` VALUES(17, 0, 1, 1, 4, 'mainPageRootTree', '/', NULL, NULL, 'main', 0, NULL, 0, NULL, NULL, NULL, 1, '2016-02-17 10:18:19', 0, 0);
INSERT INTO `tbl_pages` VALUES(18, 17, 2, 2, 3, 'main', 'Главная страница', NULL, 0, 'main', 0, '', 1, '', '', '', 1, '2016-02-17 10:18:58', 0, 0);
...
DROP TABLE IF EXISTS `tbl_pages_tabs`;
CREATE TABLE IF NOT EXISTS `tbl_pages_tabs` (
  ...
  KEY `title` (`title`(255))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Вкладки' AUTO_INCREMENT=101 ;
...
DROP TABLE IF EXISTS `tbl_photo_elements`;
...
DROP TABLE IF EXISTS `tbl_photo_rubrics`;
...
DROP TABLE IF EXISTS `tbl_photo_template`;
...
DROP TABLE IF EXISTS `tbl_press_group`;
...
DROP TABLE IF EXISTS `tbl_review_author`;
...
DROP TABLE IF EXISTS `tbl_review_elements`;
...
DROP TABLE IF EXISTS `tbl_review_rubrics`;
...
DROP TABLE IF EXISTS `tbl_site_module_settings`;
...
INSERT INTO `tbl_user_role` VALUES(6, 'guest', 'Гость', 0);
INSERT INTO `tbl_user_role` VALUES(7, 'user', 'Пользователь', 1);
INSERT INTO `tbl_user_role` VALUES(9, 'admin', 'Администратор', 10);
...
DROP TABLE IF EXISTS `tbl_yandex_map`;
