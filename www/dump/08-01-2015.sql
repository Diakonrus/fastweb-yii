...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 08 2016 г., 15:02
...
--
-- База данных: `beauty-trend`
--

-- --------------------------------------------------------

--
-- Структура таблицы `tbl_article_elements`
--

CREATE TABLE IF NOT EXISTS `tbl_article_elements` (
...
--
-- Структура таблицы `tbl_article_rubrics`
--

CREATE TABLE IF NOT EXISTS `tbl_article_rubrics` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `tbl_catalog_settings`
--

CREATE TABLE IF NOT EXISTS `tbl_catalog_settings` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `img_small` int(11) DEFAULT NULL COMMENT 'размер маленькой картинки small в X',
  `img_medium` int(11) DEFAULT NULL COMMENT 'размер средней картинки medium в X',
  `img_medium2` int(11) DEFAULT NULL COMMENT 'размер картинки medium2 в X',
  `watermark_pos` int(2) unsigned DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `tbl_doctor_rubrics` (
  ...
  `color` varchar(50) NOT NULL DEFAULT '#ed174f',
  `meta_title` varchar(350) DEFAULT NULL,
  `meta_keywords` text,
  `meta_description` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Структура таблицы `tbl_html_code`
--

CREATE TABLE IF NOT EXISTS `tbl_html_code` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `code` text NOT NULL,
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1-активно 0-не кативно',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `tbl_menu` (
  ...
  `image` varchar(350) DEFAULT NULL COMMENT 'Катинка меню',
  `access_lvl` int(11) unsigned DEFAULT NULL,
  `active` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 - не активно, 1 - активно',
  `parent_id` int(11) unsigned DEFAULT '0' COMMENT 'Родительское меню',
  `type_form` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0-обычное меню 1-меню круговых ссылок',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `parent_id` (`parent_id`),
  KEY `type_form` (`type_form`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=61 ;

-- --------------------------------------------------------

--
-- Структура таблицы `tbl_menu_template`
--

CREATE TABLE IF NOT EXISTS `tbl_menu_template` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(350) NOT NULL,
  `param_menu` varchar(550) NOT NULL COMMENT 'Параметры меню указываю через |',
  `body` text COMMENT 'код меню который будет вставляться в темплейт',
  `script` text COMMENT 'JS скрипты',
  `style` text COMMENT 'CSS стили',
  `float` tinyint(1) unsigned DEFAULT NULL COMMENT 'ориентация меню 1-горизонтальное 2-вертикальное',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 - не активный шаблон (не используется для меню) 1- активный',
  `base_template_head` text,
  `base_template_body_link` text,
  `base_template_body_menu` text,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `tbl_news` (
  ...
  KEY `status` (`status`),
  FULLTEXT KEY `name` (`name`,`brieftext`,`description`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=279 ;
...
CREATE TABLE IF NOT EXISTS `tbl_pages` (
  ...
  `title_page` varchar(250) DEFAULT NULL,
  `url` varchar(250) NOT NULL,
  `image` varchar(350) DEFAULT NULL,
  `access_lvl` int(11) DEFAULT NULL,
  `controller_name` varchar(250) DEFAULT NULL,
  `main_template` varchar(50) DEFAULT 'main',
  `main_page` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `menu_id` int(11) unsigned DEFAULT NULL,
  `type_module` int(11) DEFAULT NULL,
  `size_css` int(2) unsigned NOT NULL DEFAULT '1',
  `content` text,
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1-не активно, 2-активно',
  `basement` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `meta_title` varchar(250) DEFAULT NULL,
  `meta_keywords` text,
  `meta_description` text,
  PRIMARY KEY (`id`),
  UNIQUE KEY `url` (`url`),
  KEY `FK_tbl_pages_tbl_menu` (`menu_id`)
...
CREATE TABLE IF NOT EXISTS `tbl_pages_tabs` (
  ...
  KEY `title` (`title`(255))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Вкладки' AUTO_INCREMENT=172 ;

-- --------------------------------------------------------

--
-- Структура таблицы `tbl_photoalbum`
--

CREATE TABLE IF NOT EXISTS `tbl_photoalbum` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(350) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1-активно 0-не активно',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
--
-- Структура таблицы `tbl_photoalbum_elements`
--

CREATE TABLE IF NOT EXISTS `tbl_photoalbum_elements` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `photoalbum_id` int(11) unsigned NOT NULL,
  `image` varchar(50) DEFAULT NULL,
  `name` varchar(450) DEFAULT NULL,
  `url` varchar(450) DEFAULT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `FK_tbl_photoalbum_elements_tbl_photoalbum` (`photoalbum_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=133 ;

-- --------------------------------------------------------

--
-- Структура таблицы `tbl_photoalbum_template`
--

CREATE TABLE IF NOT EXISTS `tbl_photoalbum_template` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(350) NOT NULL,
  `val` text NOT NULL,
...
--
-- Структура таблицы `tbl_review_author`
--

CREATE TABLE IF NOT EXISTS `tbl_review_author` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(450) DEFAULT NULL,
  `email` varchar(450) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Структура таблицы `tbl_review_elements`
--

CREATE TABLE IF NOT EXISTS `tbl_review_elements` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) unsigned NOT NULL,
  `author_id` int(11) unsigned DEFAULT NULL,
...
--
-- Структура таблицы `tbl_review_rubrics`
--

CREATE TABLE IF NOT EXISTS `tbl_review_rubrics` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) unsigned NOT NULL DEFAULT '0',
  `left_key` int(11) unsigned NOT NULL,
  `level` int(11) unsigned NOT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Список подклюеных модулей' AUTO_INCREMENT=18 ;
...
--
-- Ограничения внешнего ключа таблицы `tbl_photoalbum_elements`
--
ALTER TABLE `tbl_photoalbum_elements`
  ADD CONSTRAINT `FK_tbl_photoalbum_elements_tbl_photoalbum` FOREIGN KEY (`photoalbum_id`) REFERENCES `tbl_photoalbum` (`id`);

--
-- Ограничения внешнего ключа таблицы `tbl_review_elements`
--
ALTER TABLE `tbl_review_elements`
  ADD CONSTRAINT `FK_tbl_review_elements_tbl_review_author` FOREIGN KEY (`author_id`) REFERENCES `tbl_review_author` (`id`),
  ADD CONSTRAINT `FK_tbl_review_elements_tbl_review_rubrics` FOREIGN KEY (`parent_id`) REFERENCES `tbl_review_rubrics` (`id`);
