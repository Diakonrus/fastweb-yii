...
<div class="control-group">
    ...
    <div class="controls">
        <select name="BanersRubrics[parent_id]" id="BanersRubrics_parent_id" class="span5" <?=!$model->isNewRecord?'disabled':'';?>>
...
<div class="control-group">
    <label class="control-label" for="BanersalbumElements_imagefile">Картинка фотоальбома</label>
    <div class="controls">
        <?php if ($model->isNewRecord) { ?><img src="/images/nophoto_100_100.jpg"><?php } else {
            ...
            if (file_exists( YiiBase::getPathOfAlias('webroot').'/../uploads/filestorage/baners/rubrics/admin-'.$model->id.'.'.$model->image )) {
                $url_img = '/../uploads/filestorage/baners/rubrics/admin-'.$model->id.'.'.$model->image;
            }
            echo '<a href="/../uploads/filestorage/baners/rubrics/'.$model->id.'.'.$model->image.'" target="_blank"><img src="'.$url_img.'"></a>';
        } ?>
        <br>
