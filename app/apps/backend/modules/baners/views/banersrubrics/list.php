...
<legend><?php echo Yii::t("Bootstrap", "LIST.BanersRubrics" ) ?></legend>
        ...
        array(
            ...
            'buttons' => array(
                'move_up' => array(
                    ...
                    'url'=>'"/admin/baners/banersrubrics/move?id=$data->id&move=1"',
                    'options'=>array(
                        'class'=>'icon-arrow-up',
                ...
                'move_down' => array(
                    'label'=>'',
                    'visible'=>'(($row+1)==BanersRubrics::model()->count("level=$data->level"))?false:true',
                    'url'=>'"/admin/baners/banersrubrics/move?id=$data->id&move=2"',
                    'options'=>array(
