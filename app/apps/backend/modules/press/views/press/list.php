...
<legend><?php echo Yii::t("Bootstrap", "LIST.Press" ) ?></legend>
	...
	'columns'=>array(
        ...
        /*
            array(
                ...
                'name'=> "status",
                'value' => 'Press::model()->getDownliststatus($data->status)',
                'filter' => Press::model()->getStatuslist(),
        ),
        */
...
<a href="/admin/<?=Yii::app()->controller->module->id;?>/<?=Yii::app()->controller->id;?>/create" class="btn">Добавить новость</a>
