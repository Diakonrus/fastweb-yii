...
<legend><?php echo Yii::t("Bootstrap", "LIST.PressGroup" ) ?></legend>
...
$this->widget('bootstrap.widgets.TbExtendedGridView',array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'buttons' => array(
                'link' => array(
                    'label'=> 'Список записей группы',
                    'options'=>array(
                        //'class' => 'btn btn-small update',
                        'target' => '_blank',
                    ),
                    'url'=>'Yii::app()->createUrl("/press/press/index", array("Press[group_id]"=>$data->id))',
                ),
            ),
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'url'=>'CHtml::normalizeUrl(array("update", "id" => $data->id))', //'Yii::app()->controller->itemUrl("pressgroup/update/id/" . $data->id)',
                    'options'=>array(
                        //'class'=>'btn btn-small update'
                    ),
                ),
