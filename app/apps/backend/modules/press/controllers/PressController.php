...
class PressController extends Controller
{
	...
	*/
        ...
        if(isset($_POST['Press']))
        {
            ...
            if($model->save()){
                ...
                if (isset($model->imagefile) && $modelSettings = SiteModuleSettings::model()->find('site_module_id = 14')){
                    ...
                    $filepatch = '/../uploads/filestorage/press/elements/';
    ...
    public function actionUpdate($id)
    {
        ...
        if(isset($_POST['Press']))
        {
            ...
            $model->attributes=$_POST['Press'];
            $model->maindate = $_POST['Press']['maindate'];
	...
	*/
    ...
    private function chgImgPress($patch, $imgOld, $imgNew){
