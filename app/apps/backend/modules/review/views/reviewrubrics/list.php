...
<legend><?php echo Yii::t("Bootstrap", "LIST.ReviewRubrics" ) ?></legend>

<?php

$assetsDir = Yii::app()->basePath;
$labels = ReviewRubrics::model()->attributeLabels();


$this->widget('bootstrap.widgets.TbExtendedGridView',array(

    'id'=>'review-group-grid',
    'template' => "{items}\n{pager}",
    'enableHistory' => true,
    ...
    'columns'=>array(
        ...
        */
        ...
        array(
            ...
            'type'=>'raw',
            'value' =>  function($data){
                $count = ReviewRubrics::getCountTree($data->left_key,$data->right_key);
                return '
                    <a href="/admin/review/reviewrubrics/index?id='.$data->id.'" target="_blank">
                        <b>'.$count.'</b>
                    </a>
                ';
            },
        ...
        array(
            ...
            'buttons' => array(
                'move_up' => array(
                    ...
                    'url'=>'"/admin/review/reviewrubrics/move?id=$data->id&move=1"',
                    'options'=>array(
                        'class'=>'icon-arrow-up',
                ...
                'move_down' => array(
                    'label'=>'',
                    'visible'=>'(($row+1)==ReviewRubrics::model()->count("level=$data->level"))?false:true',
                    'url'=>'"/admin/review/reviewrubrics/move?id=$data->id&move=2"',
                    'options'=>array(
