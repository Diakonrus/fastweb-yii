 ...
 * @var $model ReviewRubrics
 */

$form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'review-rubrics-form',
...
<div class="control-group">
    ...
    <div class="controls">
        <select name="ReviewRubrics[parent_id]" id="CatalogRubrics_parent_id" class="span5" <?=!$model->isNewRecord?'disabled':'';?>>
...
<div class="control-group">
    <label class="control-label" for="ReviewElements_status">Картинка</label>
    <div class="controls">
        <?php if ($model->isNewRecord) { ?><img src="/images/nophoto_100_100.jpg"><?php } else {
            ...
            if (file_exists( YiiBase::getPathOfAlias('webroot').'/../uploads/filestorage/review/rubrics/admin-'.$model->id.'.'.$model->image )) {
                $url_img = '/../uploads/filestorage/review/rubrics/admin-'.$model->id.'.'.$model->image;
            }
            echo '<a href="/../uploads/filestorage/review/rubrics/'.$model->id.'.'.$model->image.'" target="_blank"><img src="'.$url_img.'"></a>';
        } ?>
        <br>
