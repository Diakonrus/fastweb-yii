...
class ReviewauthorController extends Controller
{
	...
	*/
	...
	public function actionUpload(){
        ...
        $webFolder = '/uploads/reviewauthor/';
	...
	public function actionDelete($id = null)
	{
		if(Yii::app()->request->isPostRequest)
		{
            ...
            foreach($list as $id){
				...
				ReviewElements::model()->deleteAll('author_id = '.$id);
	...
	{
		$dataProvider=new CActiveDataProvider('ReviewAuthor');
	...
	*/
	...
	public function actionIndex()
	{
        ...
        $provider=new CActiveDataProvider('ReviewAuthor', $data);
	...
	{
		$model=ReviewAuthor::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='review-author-form')
		{
