...
<legend><?php echo Yii::t("Bootstrap", "LIST.Faq" ) ?></legend>
...
$this->widget('bootstrap.widgets.TbExtendedGridView',array(
	...
	'columns'=>array(
            ...
            'filter' => CHtml::listData( FaqAuthor::model()->findAll( array('order'=>'name') ), 'id', 'name'),
        ),
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'url'=>'CHtml::normalizeUrl(array("update", "id" => $data->id))', //'Yii::app()->controller->itemUrl("faqelements/update/id/" . $data->id)',
                    'options'=>array(
