...
<legend><?php echo Yii::t("Bootstrap", "LIST.EmailTemplate" ) ?></legend>
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'url'=>'CHtml::normalizeUrl(array("update", "id" => $data->id))', //'Yii::app()->controller->itemUrl("emailtemplate/update/id/" . $data->id)',
                    'options'=>array(
