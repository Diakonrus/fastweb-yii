...
class PhototemplateController extends Controller
{
	...
	*/
	...
	public function actionCreate()
	{
		$this->breadcrumbs = array(
			'Шаблон фотогалереи'=>array('/photo/phototemplate'),
			'Новая запись'
		);
	...
	public function actionUpload(){
        ...
        $webFolder = '/uploads/phototemplate/';
	...
	{
		$dataProvider=new CActiveDataProvider('PhotoTemplate');
	...
	*/
	...
	public function actionIndex()
	{
		...
		$model=new PhotoTemplate('search');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='photo-template-form')
		{
