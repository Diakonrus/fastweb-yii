...
class GeoregionController extends Controller
{
	...
	public function actionView($id)
	{
		...
		if(isset($_GET['GeoRegion'])){
			$model->attributes=$_GET['GeoRegion'];
        }
	...
	*/
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['GeoRegion'];
	...
	{
		$dataProvider=new CActiveDataProvider('GeoRegion');
	...
	*/
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='geo-region-form')
		{
