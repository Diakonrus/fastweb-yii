...
<?php
echo $form->dropDownListRow($model,'user_role_id',UserGroupRule::model()->getRoleList(),
    array('class'=>'span5'));
?>
<?php
echo $form->dropDownListRow($model,'module_id',UserGroupRule::model()->getModulesList(),
    array('class'=>'span5'));
?>
<?php
echo $form->dropDownListRow($model,'access_type',UserGroupRule::model()->getAccessType(),
    array('class'=>'span5'));
?>
