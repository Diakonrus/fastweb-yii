...
class UsergroupruleController extends Controller
{
	...
	public function actionView($id)
	{
		...
		if(isset($_GET['UserGroupRule'])){
			$model->attributes=$_GET['UserGroupRule'];
        }
	...
	*/
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UserGroupRule']))
		{
			$model->attributes=$_POST['UserGroupRule'];
	...
	public function actionUpload(){
        ...
        $webFolder = '/uploads/usergrouprule/';
	...
	{
		$dataProvider=new CActiveDataProvider('UserGroupRule');
	...
	*/
	...
	public function actionIndex()
	{
		$model=new UserGroupRule('search');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-group-rule-form')
		{
