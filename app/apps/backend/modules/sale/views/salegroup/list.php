...
<legend><?php echo Yii::t("Bootstrap", "LIST.SaleGroup" ) ?></legend>

<?php

$assetsDir = Yii::app()->basePath;
$labels = SaleGroup::model()->attributeLabels();
        ...
        array(
            ...
            'buttons' => array(
                'link' => array(
                    ...
                    'url'=>'Yii::app()->createUrl("/sale/sale/index", array("Sale[group_id]"=>$data->id))',
                ),
            ),
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'url'=>'CHtml::normalizeUrl(array("update", "id" => $data->id))', //'Yii::app()->controller->itemUrl("salegroup/update/id/" . $data->id)',
                    'options'=>array(
                        //'class'=>'btn btn-small update'
                    ),
                ),
