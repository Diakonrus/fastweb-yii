...
<?php
echo $form->dropDownListRow($model,'param_design',SaleGroup::model()->getParamDesign(),
    array('class'=>'span5'));
?>
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
        $base_url_img = '/../uploads/filestorage/sale/rubrics/';
        ?>
...
<?php
echo $form->dropDownListRow($model,'status',SaleGroup::model()->getStatuslist(),
    array('class'=>'span5'));
?>
