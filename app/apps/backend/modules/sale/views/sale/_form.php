...
<?php echo $form->dropDownListRow($model, "group_id",
    CHtml::listData( SaleGroup::model()->findAll(), "id", "name"),
    array('class'=>'span5', "empty" => "Нет группы")
); ?>

<?php echo '<label class="control-label required">Главные акции(показывать на главной странице)</label> <div class="controls">' . $form->dropDownList($model,'primary', array('0'=>'Нет','1'=>'Да'), array('name' => 'Sale[primary]', 'title' => 'Главные новости')) . '</div>'; ?>
...
$this->widget('ImperaviRedactorWidget', array(
    ...
    'options' => array(
        'lang' => 'ru',
        'imageUpload' => Yii::app()->createAbsoluteUrl('/sale/sale/imageUpload'),
    ),
    'plugins' => array(
        'fullscreen' => array(
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
        $base_url_img = '/../uploads/filestorage/sale/elements/';
        ?>
...
<?php
echo $form->dropDownListRow($model,'status',Sale::model()->getStatuslist(),
    array('class'=>'span5'));
?>
