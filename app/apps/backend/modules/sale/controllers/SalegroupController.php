...
class SalegroupController extends Controller
{
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('SaleGroup');
	...
	*/
	...
	{
		$model=SaleGroup::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sale-group-form')
		{
