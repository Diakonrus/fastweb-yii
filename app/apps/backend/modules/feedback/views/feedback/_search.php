<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo echo $form->textFieldRow($model,'fio',array('class'=>'span5','maxlength'=>550));; ?>

	<?php echo echo $form->textFieldRow($model,'phone',array('class'=>'span5','maxlength'=>20));; ?>

	<?php echo echo $form->textFieldRow($model,'email',array('class'=>'span5','maxlength'=>550));; ?>
	...
	<?php echo echo $form->DatePickerRow($model, 'answer_at', array(
				'options'=>array(
					'autoclose' => true,
					//'showAnim'=>'fold',
					'type' => 'Component',
				...
				'htmlOptions'=>array(
					//'value'=> strlen($model->answer_at) > 0 ? Yii::app()->dateFormatter->format('yyyy-MM-dd', $model->answer_at) : '',
					//'class'=>'span2'
				),
			));; ?>
