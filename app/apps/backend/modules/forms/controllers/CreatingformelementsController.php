...
class CreatingformelementsController extends Controller
{
	...
	*/
	...
	public function actionUpload(){
        ...
        $webFolder = '/uploads/creatingformelements/';
	...
	{
		$dataProvider=new CActiveDataProvider('CreatingFormElements');
	...
	*/
	...
	public function actionIndex()
	{
		$model=new CreatingFormElements('search');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='creating-form-elements-form')
		{
