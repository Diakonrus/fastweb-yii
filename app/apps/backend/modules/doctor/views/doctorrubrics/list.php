...
<legend><?php echo Yii::t("Bootstrap", "LIST.DoctorRubrics" ) ?></legend>
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'url'=>'CHtml::normalizeUrl(array("update", "id" => $data->id))', //'Yii::app()->controller->itemUrl("doctorrubrics/update/id/" . $data->id)',
                    'options'=>array(
