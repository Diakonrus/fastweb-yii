...
<legend><?php echo Yii::t("Bootstrap", "LIST.HtmlCode" ) ?></legend>

<?php

$assetsDir = Yii::app()->basePath;
$labels = HtmlCode::model()->attributeLabels();
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'url'=>'CHtml::normalizeUrl(array("update", "id" => $data->id))', //'Yii::app()->controller->itemUrl("htmlcode/update/id/" . $data->id)',
                    'options'=>array(
...
<div class="buttons">
    <a class="btn btn-primary" href="/admin/<?=Yii::app()->controller->module->id;?>/<?=Yii::app()->controller->id;?>/create?id=<?=(isset($_GET['id']))?(int)$_GET['id']:0;?>" style="margin-top:14px; float:left; margin-left:15px"> Добавить новую запись</a>
</div>
