...
class HtmlcodeController extends Controller
{
	...
	public function actionView($id)
	{
		...
		if(isset($_GET['HtmlCode'])){
			$model->attributes=$_GET['HtmlCode'];
        }
	...
	*/
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['HtmlCode'];
	...
	{
		$dataProvider=new CActiveDataProvider('HtmlCode');
	...
	*/
	...
	{
		$model=HtmlCode::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='html-code-form')
		{
