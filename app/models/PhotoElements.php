...
/**
 * This is the model class for table "{{photo_elements}}".
 *
 * The followings are the available columns in table '{{photo_elements}}':
 * @property integer $id
 ...
 */
class PhotoElements extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'parent' => array(self::BELONGS_TO, 'PhotoRubrics', 'parent_id'),
		);
	}
	 ...
	 * @return PhotoElements the static model class
	 */
