...
/**
 * This is the model class for table "{{baners_rubrics}}".
 *
 * The followings are the available columns in table '{{baners_rubrics}}':
 * @property integer $id
 ...
 * @property banersElements[] $banersElements
 */
class BanersRubrics extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'banersElements' => array(self::HAS_MANY, 'BanersElements', 'parent_id'),
		);
	}
	 ...
	 * @return banersRubrics the static model class
	 */
    ...
    public static function getCountTree($left_key, $right_key){
        $model = Yii::app()->db->createCommand()
            ...
            ->from(BanersRubrics::model()->tableName())
