...
class RegistrationForm extends CFormModel {
	...
	public function rules() {
		...
		return array(
			...
			array('email, birthday, first_name, last_name, password, phone, city_id', 'required', 'message'=>'Не заполнено поле "{attribute}"'),
    ...
    public function beforeValidate(){
        ...
        if (empty($this->city_id)) { $this->city_id = 11101; /*по умолчанию город Москва*/ }
