...
class ArticleElements extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('brieftext, description, created_at', 'safe'),
			array('imagefile', 'file', 'types'=>'jpg, gif, png, jpeg', 'allowEmpty' => true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, parent_id, primary, name, brieftext, description, image, status, meta_title, meta_keywords, meta_description, maindate, keyword, created_at,
                   ', 'safe', 'on'=>'search'),
		);
	}
